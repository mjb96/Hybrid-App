...
function renderBuilderUI(program) {
  ...
  container.innerHTML = `
    ...
    <div class="card-dark p-4 mb-4">
      ...
      <p class="text-xs text-muted" style="margin-top:8px;">Add the lifts you want to train on each day. Sets &amp; reps follow the program's weekly targets. Leave a day on "Rest" with no lifts for a rest day.</p>
    </div>
