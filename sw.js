...
// ==========================================
const CACHE_NAME = 'helyx-v122-ha9231bb5cc50';
...
const REQUIRED_ASSETS = [
  ...
  "./js/workout-order.js",
  "./js/workout.js",
  "./js/workout/clear-log.js",
  "./js/workout/completion-policy.js",
  "./js/workout/context.js",
  ...
  "./js/workout/run-logging.js",
  "./js/workout/run-type.js",
  "./js/workout/run-units.js",
